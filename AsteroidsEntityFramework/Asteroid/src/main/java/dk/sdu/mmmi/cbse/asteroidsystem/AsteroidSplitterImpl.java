...
public class AsteroidSplitterImpl implements IAsteroidSplitter {
    ...
    public void createSplitAsteroid(Entity e, World world) {
        ...
        float by1 = (float) MathUtils.sin(radians1) * e.getRadius() * asteroid1.getRadius();
        float bx1 = (float) MathUtils.cos(radians1) * e.getRadius() * asteroid1.getRadius();
        ...
        float by2 = (float) MathUtils.sin(radians2) * e.getRadius() * asteroid2.getRadius();
        float bx2 = (float) MathUtils.cos(radians2) * e.getRadius() * asteroid2.getRadius();
